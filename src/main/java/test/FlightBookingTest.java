...
public class FlightBookingTest {
	...
	/**
	 * This test connects to the clear trip flight ticket booking portal, selects
	 * the boarding and destination airport, picks the journey start date as
	 * current date ,submits the details and then validates the search results
	 * 
